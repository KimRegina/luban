...
namespace Luban.Regina;

[SchemaCollector("regina")]
public class ReginaSchemaCollector : SchemaCollectorBase
{
    ...
    public override void Load(LubanConfig config)
    {
        ...
        {
            s_logger.Info("regina import schema file:{} type:{}", importFile.FileName, importFile.Type);
